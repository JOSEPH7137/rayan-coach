...
function loadPageContent(page) {
    ...
    const pages = {
        ...
        `,
        drivers: `
            <div class="dashboard-card"><div class="card-title"><i class="fas fa-users"></i><span>Drivers Management</span><button class="btn-dashboard btn-primary" style="margin-left: auto;" onclick="showToast('Add driver form opened','info')">+ Add Driver</button></div>
                <table class="data-table"><thead> <tr><th>Driver</th><th>Phone</th><th>License</th><th>Status</th><th>Rating</th><th>Actions</th></tr> </thead><tbody>
                    <tr><td>James Mwangi</td><td>0722 000001</td><td>PSV-KE-2024-00821</td><td><span class="trip-status status-upcoming">Active</span></td><td>4.9 ★</td><td><button class="btn-dashboard btn-outline btn-sm" onclick="showToast('Edit driver','info')">Edit</button></td></tr>
                    <tr><td>Peter Omondi</td><td>0722 000002</td><td>PSV-KE-2024-00822</td><td><span class="trip-status status-upcoming">Active</span></td><td>4.8 ★</td><td><button class="btn-dashboard btn-outline btn-sm" onclick="showToast('Edit driver','info')">Edit</button></td></tr>
                    <tr><td>Mary Wanjiku</td><td>0722 000003</td><td>PSV-KE-2024-00823</td><td><span class="trip-status status-upcoming">Active</span></td><td>4.9 ★</td><td><button class="btn-dashboard btn-outline btn-sm" onclick="showToast('Edit driver','info')">Edit</button></td></tr>
                    <tr><td>John Otieno</td><td>0722 000004</td><td>PSV-KE-2024-00824</td><td><span class="trip-status status-completed">On Leave</span></td><td>4.7 ★</td><td><button class="btn-dashboard btn-outline btn-sm" onclick="showToast('Edit driver','info')">Edit</button></td></tr>
                </tbody>
            </table>
            </div>
        `,
                    ...
                    <div class="trip-item">
                        <div>
                            ...
                            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px; margin-top: 8px;">
                                <div>
                                    <strong>Passenger:</strong> ${review.profiles?.name || 'Unknown'}
                                    <br>
                                    <small style="color: var(--muted);">${review.profiles?.email || ''}</small>
                                </div>
                                <div>
                                    <strong>Driver:</strong> ${review.drivers?.name || 'Not assigned'}
                                </div>
                            </div>
                            <div style="display: flex; gap: 16px; margin-top: 12px;">
                                <span style="font-size: 12px;">🚗 Journey Rating: ${review.journey_rating}/5</span>
                                <span style="font-size: 12px;">👨‍✈️ Driver Rating: ${review.driver_rating}/5</span>
                            </div>
